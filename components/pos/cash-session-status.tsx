...
import { Loader2, DollarSign, Clock, Store, LogOut, LogIn, ChevronDown, ChevronUp, TrendingUp, TrendingDown } from "lucide-react"
            ...
            <div className="mt-4 space-y-4 animate-in slide-in-from-top-4 duration-500 fade-in">
              ...
              {summary && (
                <div className="border-t-2 border-green-200 pt-4">
                  ...
                  {/* Desglose detallado con glassmorphism */}
                  <div className="bg-white/70 backdrop-blur-md rounded-xl p-4 space-y-2.5 text-xs shadow-lg border border-green-100">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h4 className="font-bold text-sm text-green-900">Desglose de Efectivo</h4>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center py-1.5 px-2 rounded-lg hover:bg-green-50/50 transition-colors">
                        ...
                        <span className="font-bold text-green-900">${session.fondo_inicial.toLocaleString("es-CO")}</span>
                      </div>
                      ...
                      {summary.ventas.efectivo > 0 && (
                        <div className="flex justify-between items-center py-1.5 px-2 rounded-lg hover:bg-emerald-50/50 transition-colors">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-green-700 font-medium">Ventas (Efectivo):</span>
                          </div>
                          <span className="font-bold text-emerald-600">+${summary.ventas.efectivo.toLocaleString("es-CO")}</span>
                        </div>
                      )}
                      ...
                      {summary.movimientos.ingresosEfectivo > 0 && (
                        <div className="flex justify-between items-center py-1.5 px-2 rounded-lg hover:bg-emerald-50/50 transition-colors">
                          ...
                          <span className="font-bold text-emerald-600">+${summary.movimientos.ingresosEfectivo.toLocaleString("es-CO")}</span>
                        </div>
                      )}
                      ...
                      {summary.retiros.monto > 0 && (
                        <div className="flex justify-between items-center py-1.5 px-2 rounded-lg hover:bg-red-50/50 transition-colors">
                          ...
                          <span className="font-bold text-red-600">-${summary.retiros.monto.toLocaleString("es-CO")}</span>
                        </div>
                      )}
                      ...
                      {summary.gastos.monto > 0 && (
                        <div className="flex justify-between items-center py-1.5 px-2 rounded-lg hover:bg-red-50/50 transition-colors">
                          ...
                          <span className="font-bold text-red-600">-${summary.gastos.monto.toLocaleString("es-CO")}</span>
                        </div>
                      )}
                      ...
                      {summary.movimientos.egresosEfectivo > 0 && (
                        <div className="flex justify-between items-center py-1.5 px-2 rounded-lg hover:bg-red-50/50 transition-colors">
                          ...
                          <span className="font-bold text-red-600">-${summary.movimientos.egresosEfectivo.toLocaleString("es-CO")}</span>
                        </div>
                      )}
                    </div>
