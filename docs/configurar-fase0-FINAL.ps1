...
# =====================================================
# 1. CREAR ARCHIVOS .env Y .env.local
# =====================================================

Write-Host "[1/3] Creando archivos de configuracion..." -ForegroundColor Yellow
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "    3. Verifica que la base de datos AgroShop exista con A mayuscula" -ForegroundColor White
    Write-Host "    4. Ejecuta en pgAdmin: CREATE DATABASE ""AgroShop"";" -ForegroundColor Cyan
    Write-Host ""
    exit 1
}
...
if (Test-Path "prisma/schema.prisma") {
    ...
    Write-Host "Estadisticas de la BD:" -ForegroundColor Cyan
    Write-Host "  -> $modelCount tablas sincronizadas con Prisma" -ForegroundColor White
    Write-Host ""
}
...
Write-Host "     - Implementar NextAuth.js" -ForegroundColor Gray
Write-Host "     - Crear usuarios en la BD" -ForegroundColor Gray
Write-Host "     - Migrar pagina de login" -ForegroundColor Gray
Write-Host ""
